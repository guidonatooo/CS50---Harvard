...
int main (void)
{
    ...
    while (card < 0 ); //card number must be higher than 0
    ...
    card11 = ((card % 1000000)/100000);
    card12 = ((card % 100000000)/10000000);
    card13 = ((card % 10000000000)/1000000000);
    card14 = ((card % 1000000000000)/100000000000);
    card15 = ((card % 100000000000000)/10000000000000);
    card16 = ((card % 10000000000000000)/1000000000000000);
